...
export class SessionsService {
  ...
  async createSession(body: NewSession): Promise<ReturnResponse | ReturnError> {
    ...
    const verifyConsultation =
      await consultationsRepository.fetchConsultationByPatientIdAndTherapistId(
        patientId,
        therapistId,
      );
  ...
  async fetchAllSessionsByPatientId(
    ...
    const sessions = await sessionsRepository.fetchAllSessionsByPatientId(
      patientId,
      limit,
      offset,
    );
  ...
  async fetchAllSessionsByTherapistId(
    ...
    const sessions = await sessionsRepository.fetchAllSessionsByTherapistId(
      therapistId,
      limit,
      offset,
    );
  ...
  async updateSession(
    id: ULID,
    updatedData: Partial<NewSession>,
  ): Promise<ReturnResponse | ReturnError> {
