...
export class TherapistsService {
  ...
  async fetchAllTherapists(page: number, limit: number): Promise<ReturnResponse | ReturnError> {
    ...
    const therapists = await therapistRepository.fetchAllTherapists(limit, offset);
  ...
  async getAllTherapistsByNameHospital(
    ...
    const therapists = await therapistRepository.fetchTherapistsByUserNameAndHospitalName({
      username: name,
  ...
  async updateTherapist(id: ULID, body: NewTherapist): Promise<ReturnResponse | ReturnError> {
