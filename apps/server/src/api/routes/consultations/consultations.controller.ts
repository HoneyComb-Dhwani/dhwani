...
export class ConsultationsController {
  ...
  @Get('/')
  async fetchAllConsultations(@Query('page') page: number, @Query('limit') limit: number) {
  ...
  async fetchConsultationsByHospitalId(
    ...
    return this.consultationsService.fetchConsultationsByHospitalId(hospitalId, page, limit);
  }
  ...
  async fetchConsultationsByPatientId(
    ...
    return this.consultationsService.fetchConsultationsByPatientId(patientId, page, limit);
  }
  ...
  async fetchConsultationsByTherapistId(
    ...
    return this.consultationsService.fetchConsultationsByTherapistId(therapistId, page, limit);
  }
  ...
  async updateConsultation(
    ...
    return this.consultationsService.updateConsultation(consultationId, consultationData);
  }
