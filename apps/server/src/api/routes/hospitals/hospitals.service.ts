...
export class HospitalService {
  ...
  async createHospital(body: CreateHospitalDto): Promise<ReturnResponse | ReturnError> {
  ...
  async fetchAllHospitals(page: number, limit: number): Promise<ReturnResponse | ReturnError> {
  ...
  async updateHospital(id: ULID, body: NewHospital): Promise<ReturnResponse | ReturnError> {
