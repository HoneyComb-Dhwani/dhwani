...
### **2.2 Therapist**
- **Registration & Login**: Therapists are assigned credentials by the Supervisor in their hospital. The login ID is typically formatted as `therapist1@kauveryhospital`, where "therapist1" is the unique identifier, and "kauveryhospital" is the hospital domain.
...
### **2.3 Supervisor**
- **Registration & Login**: Supervisors are typically one per hospital and are responsible for managing and overseeing the therapists. The login ID is formatted as `supervisor@kauveryhospital`, where "supervisor" is the identifier and "kauveryhospital" is the hospital domain.
